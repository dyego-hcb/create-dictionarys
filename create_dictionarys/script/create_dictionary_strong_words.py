...
from script.create_dictionary_words_group import create_dictionary_words_group, update_dictionary_words_group, save_dict_words_group_to_xlsx, save_dict_words_group_to_csv
from script.create_dictionary_words import create_dictionary_words, update_dictionary_words, save_dict_words_to_xlsx, save_dict_words_to_csv
...
dict_notice_real, words_total_with_stopwords_group_real, words_total_without_stopwords_group_real = create_dictionary_notices(
    path_bd, 1)

outpat_notice = os.path.join(project_root, 'output', 'dict_notice_real.csv')
save_dict_notice_to_csv(outpat_notice, dict_notice_real, 'Reais',
                        words_total_with_stopwords_group_real, words_total_without_stopwords_group_real)
...
dict_words_real = create_dictionary_words_group(
    dict_words_real, dict_notice_real)
dict_words_real = update_dictionary_words_group(
    dict_words_real, dict_notice_real, words_total_with_stopwords_group_real, words_total_without_stopwords_group_real)

words_dict_real_total = len(dict_words_real)

outpat_words = os.path.join(project_root, 'output', 'dict_words_real.csv')
save_dict_words_group_to_csv(outpat_words, dict_words_real, 'Reais')
...
dict_notice_fake, words_total_with_stopwords_group_fake, words_total_without_stopwords_group_fake = create_dictionary_notices(
    path_bd, 0)

outpat_notice = os.path.join(project_root, 'output', 'dict_notice_fake.csv')
save_dict_notice_to_csv(outpat_notice, dict_notice_fake, 'Fakes',
                        words_total_with_stopwords_group_fake, words_total_without_stopwords_group_fake)
...
dict_words_fake = create_dictionary_words_group(
    dict_words_fake, dict_notice_fake)
dict_words_fake = update_dictionary_words_group(
    dict_words_fake, dict_notice_fake, words_total_with_stopwords_group_fake, words_total_without_stopwords_group_fake)

words_dict_fake_total = len(dict_words_fake)

outpat_words = os.path.join(project_root, 'output', 'dict_words_fake.csv')
save_dict_words_group_to_csv(outpat_words, dict_words_fake, 'Fakes')
...
outpat_words = os.path.join(project_root, 'output', 'dict_words.csv')
save_dict_words_to_csv(outpat_words, dict_words, 'Geral')
